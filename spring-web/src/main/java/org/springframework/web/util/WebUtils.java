...
public abstract class WebUtils {
	 ...
	 * This handles parameters of the form <com.xwj.tt>logicalName = value</com.xwj.tt>. For normal
	 * parameters, e.g. submitted using a hidden HTML form field, this will return
	 * the requested value.</li>
	 * <li>Try to obtain the parameter value from the parameter name, where the
	 * parameter name in the request is of the form <com.xwj.tt>logicalName_value = xyz</com.xwj.tt>
	 ...
	 * actually be of the form <com.xwj.tt>logicalName_value.x = 123</com.xwj.tt>. </li>
	 * </ol>
