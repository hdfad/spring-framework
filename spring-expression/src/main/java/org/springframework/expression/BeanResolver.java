 ...
 * The <com.xwj.tt>&</com.xwj.tt> variant syntax allows access to the factory bean where relevant.
 *
 * @author Andy Clement
 * @since 3.0.3
 */
public interface BeanResolver {
	 ...
	 * For attempting access to a factory bean, the name needs a <com.xwj.tt>&</com.xwj.tt> prefix.
